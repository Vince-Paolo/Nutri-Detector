...
<head>
  ...
  <title>Nutri - Detector | Instructions</title>
...
<div class="page">
  <div class="shell">
    <div class="card center-card">
      <h1 class="h1">Instructions & Supported Foods</h1>
      <p class="sub">Quick guide on how to use Nutri - Detector.</p>

      <h2 class="h2" style="margin-top:18px;">How to Use</h2>
      <ol class="howto">
        <li>Open the <b>Analyze</b> page.</li>
        <li>Choose a food image (JPG/PNG/WEBP).</li>
        <li>Click <b>Analyze Food</b>.</li>
        <li>View the detected food and nutrition.</li>
      </ol>

      <h2 class="h2" style="margin-top:18px;">Supported Foods</h2>
      <ul class="bullets">
        <li>Apple</li>
        <li>Banana</li>
        <li>Fried Chicken</li>
      ...
      <div style="margin-top:18px; display:flex; gap:12px; flex-wrap:wrap;">
        <a class="btn" href="analyze.php">Go to Analyze</a>
